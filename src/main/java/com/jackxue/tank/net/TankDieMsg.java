...
import com.jackxue.tank.Bullet;
import com.jackxue.tank.Tank;
import com.jackxue.tank.TankFrame;
...
public class TankDieMsg extends Msg {
	...
	@Override
	public void handle() {
		System.out.println("we got a com.mashibing.tank die:" + id);
		System.out.println("and my com.mashibing.tank is:" + TankFrame.INSTANCE.getMainTank().getId());
		Tank tt = TankFrame.INSTANCE.findTankByUUID(id);
		System.out.println("i found a com.mashibing.tank with this id:" + tt);
