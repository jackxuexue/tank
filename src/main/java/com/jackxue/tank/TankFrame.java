...
import com.jackxue.tank.net.TankDirChangedMsg;
import com.jackxue.tank.net.TankStartMovingMsg;
import com.jackxue.tank.net.TankStopMsg;
...
public class TankFrame extends Frame {
	...
	private TankFrame() {
		...
		addWindowListener(new WindowAdapter() {
			...
			@Override
			public void windowClosing(WindowEvent e) { // bjmashibing/com.mashibing.tank
				System.exit(0);
			}
